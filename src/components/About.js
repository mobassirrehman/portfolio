      ...
      <div className="section-container">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">About <span className="text-zinc-500">Me</span></h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
            {highlights.map((item, index) => (
              ...
              >
                <item.icon size={32} className="text-zinc-800 dark:text-zinc-200 mb-3" />
                <span className="text-sm font-semibold text-zinc-600 dark:text-zinc-400">{item.label}</span>
              </motion.div>
            ))}
          </div>
          ...
          <div className="space-y-8">
            {[
              ...
              <div key={index} className="bg-white dark:bg-black p-8 rounded-3xl border border-zinc-200 dark:border-zinc-800">
